    ...
    <div className="container mx-auto px-4 py-6 sm:py-8 pb-28 sm:pb-8 max-w-5xl animate-fade-in" dir="rtl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-6">
          {/* Player */}
          <div className="aspect-video rounded-[40px] overflow-hidden bg-black shadow-2xl ring-1 ring-white/10 shadow-black/60 shadow-[0_0_80px_rgba(234,88,12,0.1)]">
            {activeVideo.vimeoId ? (
              <iframe
              ...
              <div className="flex flex-wrap gap-3 mt-6 pt-6 border-t border-white/5">
                {activeVideo.resources.map((res, i) => (
                  <a
                    ...
                    className="bg-orange-600 hover:bg-orange-500 text-white px-6 py-3 rounded-2xl text-sm font-bold flex items-center gap-2 transition-all shadow-lg shadow-orange-600/30 hover:shadow-orange-600/50 active:scale-95"
                  >
                    <svg className="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
